...
class CommandHandler {
    ...
    void ackReceive() {
        ...
        cout << "received " << receivedAcknowledgements << "/" << expectedAcknowledgements << endl;
    ...
    void handleClient() {
        while (broadcasting) {
            ...
            if (message == "") {
                ...
                if (fs::exists(path)) {
                    string notif = clientName + " accepted the file";
                    NetworkUtils::sendMessage(sender, notif);
                ...
                string notif = clientName + " rejected the file";
                NetworkUtils::sendMessage(sender, notif);
